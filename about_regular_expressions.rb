...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # they won't look for the longest match. They just get the first occurrence
  # whichever the length it might be
  ...
  # character class is character-wise alternation
